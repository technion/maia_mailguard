...
{form action="xadminusers.php$sid" name="adminusers"}
<div align="center">
<table border="0" cellspacing="2" cellpadding="2" width="600">

<tr>
<td class="menuheader" align="center" colspan="2">{$lang.header_users_menu}&nbsp;
...
<tr>
<td class="menuheader2" align="center" colspan="2">
...
<tr>
<td class="menuheader" align="center" colspan="2">{$lang.header_add_email}&nbsp;
...
<tr>
<td class="menuheader" align="center" colspan="2">{$lang.header_link_email}&nbsp;
<font size="3"><a href="adminhelp.php#link_email_address{$sid}" target="new">[?]</a></font></td>
</tr>

{if $addresses && $users}
    <tr><td class="menuheader2" align="center">{$lang.text_email}:</td>
    <td class="menubody2" align="left">
    ...
    <tr><td class="menuheader2" align="center">{$lang.text_user}:</td>
    <td class="menubody2" align="left">
    ...
    <tr><td class="menuheader2" align="center" colspan="2">
    <input type="submit" name="button_link" value=" {$lang.button_link_email} ">
    </td></tr>
{elseif $addresses}
    <tr><td class="menubody2" align="center" colspan="2">{$lang.text_no_users}</td></tr>
{else}
    <tr><td class="menubody2" align="center" colspan="2">{$lang.text_no_addresses}</td></tr>
{/if}
...
<tr>
<td class="menuheader" align="center" colspan="2">{$lang.header_delete_email}&nbsp;
<font size="3"><a href="adminhelp.php#delete_email_address{$sid}" target="new">[?]</a></font></td>
</tr>

{if $delete_addresses}
    <tr>
    <td class="menuheader2" align="center">{$lang.text_delete_email}:</td>
    <td class="menubody2" align="left">
...
<tr>
<td class="menuheader" align="center" colspan="2">{$lang.header_delete_user}&nbsp;
