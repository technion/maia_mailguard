...
<h2>
 {if $use_icons}
   <img src="{$template_dir}images/stats.png">&nbsp;
 {else}
   [{$lang.menu_stats}] -
 {/if}
...
<h2>
{if $use_icons}
<img src="{$template_dir}images/settings.png">&nbsp;
{else}
[{$lang.menu_settings}] - 
{/if}
...
<h2>
{if $use_icons}
<img src="{$template_dir}images/white-black-list.png">&nbsp
{else}
...
<h2>
{if $use_icons}
<img src="{$template_dir}images/quarantine.png">&nbsp;
{else}
...
<h2>
{if $use_icons}
<img src="{$template_dir}images/report-spam.png">&nbsp;
{else}
 [{$lang.menu_report} - 
{/if}
 {$lang.heading_report}
...
{if $use_icons}
<img src="{$template_dir}images/view-decoded.png">&nbsp;
{/if}
...
<h2>
{if $use_icons}
<img src="{$template_dir}images/admin-int.png">&nbsp;
{else}
[{$lang.menu_admin}] - 
{/if}
{$lang.heading_admin}
