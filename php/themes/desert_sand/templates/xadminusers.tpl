...
{elseif $button == "find"}
        {if $user}
        {capture assign="title"}{$lang.text_search_results}
          &nbsp;<font size="3"><a href="adminhelp.php#impersonate{$sid}" target="new" class="ui-icon ui-icon-help ui-border-all"></a></font>{/capture}
